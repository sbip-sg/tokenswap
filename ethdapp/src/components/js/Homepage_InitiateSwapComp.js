...
export const Homepage_InitiateSwapComp = props => {
                ...
                <div className="bg-white shadow-lg rounded px-8 pb-4 mb-3 flex-col">
                    ...
                    <div className="-mx-3 md:flex mb-6">
                        <div className="md:w-5/11 px-3 mb-6 md:mb-0">
                            ...
                            <div className="mt-1 relative rounded-md shadow-sm">
                                <input className="w-full block py-3 pl-3 pr-36 bg-purple-200 text-sm text-black rounded-md" type="text" id="txt_currencyForExc" placeholder="(Please enter Currency Value)" />
                        ...
                        <div className="md:w-5/11 px-3">
                            ...
                            <div className="mt-1 relative rounded-md shadow-sm">
                                <input className="w-full block py-3 pl-3 pr-36 bg-purple-200 text-sm text-black rounded-md" type="text" id="txt_currencyToRec" placeholder="(Please enter Currency Value)" />
                                <div className="absolute inset-y-0 right-0 flex items-center">
                    ...
                    <div className="-mx-3 md:flex mb-6">
                        <div className="md:w-2/3 px-3 mb-6 md:mb-0">
                            ...
                            <input className="w-full bg-purple-200 text-black text-sm border border-gray-300 rounded py-3 px-4 mb-3" type="text" id="txt_secretKey" placeholder="" />
                        </div>
                        <div className="md:w-1/3 px-3 mb-6 md:mb-0">
                            <label className="uppercase tracking-wide text-xs text-purple-800 font-bold mb-2" for="txt_timeoutDuration">
                                Timeout Duration (In Seconds)
                            </label>
                            <input className="w-full bg-purple-200 text-black text-sm border border-gray-300 rounded py-3 px-4 mb-3" type="text" id="txt_timeoutDuration" placeholder="(EXAMPLE: 60)" />
                        </div>
                    </div>
                    <div className="-mx-3 md:flex mb-6">
                        <div className="md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input className="w-full bg-purple-200 text-black text-sm border border-gray-300 rounded py-3 px-4 mb-3" type="text" id="txt_recipientPartyName" placeholder="" />
                        </div>
                        <div className="md:w-1/2 px-3">
                            <label className="uppercase tracking-wide text-xs text-purple-800 font-bold mb-2" for="txt_recipientAddress">
                                Recipient Address
                            </label>
                            <input className="w-full bg-purple-200 text-black text-sm border border-gray-300 rounded py-3 px-4 mb-3" type="text" id="txt_recipientAddress" placeholder="(EXAMPLE: 0x012345abcde012345)" />
                        </div>
                    </div>
                    <div className="-mx-3 md:flex mb-2">
                        <div className="md:w-1/3 px-3 mb-6 md:mb-0">
                            <button onClick={initiateSmartContract} class="bg-purple-400 hover:bg-gray-400 text-gray-800 text-sm font-bold py-2 px-4 rounded inline-flex items-center">
                                <PostAddTwoToneIcon />
